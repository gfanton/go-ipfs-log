# go-ipfs-log - API Documentation

# Log

To use `go-ipfs-log`, require the module in your project:

```go
package example

import "github.com/berty/go-ipfs-log"
```
...
#### log.NewLog(ipfs, identity, &log.NewLogOptions{ID, AccessController, Entries, Heads, Clock, SortFn})
